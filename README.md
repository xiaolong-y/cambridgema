...
**Colorblind-friendly color palettes inspired by Cambridge, Massachusetts**

Beautiful, nature-inspired color palettes designed for data visualization. All palettes are verified for accessibility under deuteranopia, protanopia, and tritanopia. From the cherry blossoms of Fresh Pond to the frozen Charles River, these palettes capture Cambridge, MA's natural beauty.
